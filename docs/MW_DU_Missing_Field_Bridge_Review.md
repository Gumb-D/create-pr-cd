...
- Best source export: `2023 TX Rollout` from `A-P202202168750_D002-2023 TX Rollout-TX Rollout PR_PO View-20260703160446.xlsx` similarity=`0.858` profile=`tx_rollout_2023_pr_v1`
...
- Bridge status: `CROSS_MODEL_REVIEW_REQUIRED`
- Reason: Another profiled export carries the missing field, but cross-model reuse is discovery-only and still requires manual four-layer review.
- Best source export: `2023 TX Rollout` from `A-P202202168750_D002-2023 TX Rollout-TX Rollout PR_PO View-20260703160446.xlsx` similarity=`0.088` profile=`tx_rollout_2023_pr_v1`
