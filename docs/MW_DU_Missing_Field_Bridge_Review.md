...
- Best source export: `TX Mini Project` from `A-P202202168750_D002-TX Mini Project-TX Mini PR_PO View-20260703160246.xlsx` similarity=`0.850` profile=`tx_mini_pr_v1`
...
- Bridge status: `CROSS_MODEL_REVIEW_REQUIRED`
- Reason: Another profiled export carries the missing field, but cross-model reuse is discovery-only and still requires manual four-layer review.
- Best source export: `Celcomdigi USP` from `A-P202202168750_D002-Celcomdigi USP-Celcomdigi USP (TX)-20260703160234.xlsx` similarity=`0.850` profile=`celcomdigi_usp_pr_v1`
