...
- Batch priority `01` `RESOLVE_MISSING_REQUIRED_FIELD` `existing_ti_pr_status`: Resolve required field `existing_ti_pr_status` before any lifecycle promotion.
  profiles (6): cd_consolidation_2023_decom_pr_v1, cd_consolidation_2023_rollout_pr_v1, celcomdigi_bau_2023_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: cd_consolidation_2023_decom_pr_v1:01, cd_consolidation_2023_rollout_pr_v1:01, celcomdigi_bau_2023_pr_v1:01, celcomdigi_usp_pr_v1:01, jendela_tx_migration_pr_v1:01, zte_tx_mini_pr_v1:01
...
- Batch priority `02` `RESOLVE_MISSING_REQUIRED_FIELD` `existing_tss_pr_status`: Resolve required field `existing_tss_pr_status` before any lifecycle promotion.
  profiles (6): cd_consolidation_2023_decom_pr_v1, cd_consolidation_2023_rollout_pr_v1, celcomdigi_bau_2023_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: cd_consolidation_2023_decom_pr_v1:02, cd_consolidation_2023_rollout_pr_v1:02, celcomdigi_bau_2023_pr_v1:02, celcomdigi_usp_pr_v1:02, jendela_tx_migration_pr_v1:02, zte_tx_mini_pr_v1:02
  hint: Review donor export 2023 TX Rollout with similarity 0.000 before deciding derived, manual, or blocking treatment.
  hint: Review donor export 2023 TX Rollout with similarity 0.088 before deciding derived, manual, or blocking treatment.
- Batch priority `03` `CONFIRM_COMPETING_CANDIDATE` `subcontractor_planning`: Choose one exact four-layer source for `subcontractor_planning` from the competing shortlist candidates.
  ...
  priority ids: celcomdigi_bau_2023_pr_v1:03, celcomdigi_bau_2024_pr_v1:01, celcomdigi_usp_pr_v1:05, jendela_tx_migration_pr_v1:04, mw_eos_swap_pr_v1:02, tx_rollout_2023_pr_v1:01, zte_tx_mini_pr_v1:05
...
- Batch priority `04` `CONFIRM_COMPETING_CANDIDATE` `tx_sow_raw`: Choose one exact four-layer source for `tx_sow_raw` from the competing shortlist candidates.
  profiles (6): cd_consolidation_2023_decom_pr_v1, cd_consolidation_2023_rollout_pr_v1, celcomdigi_bau_2023_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: cd_consolidation_2023_decom_pr_v1:06, cd_consolidation_2023_rollout_pr_v1:05, celcomdigi_bau_2023_pr_v1:04, celcomdigi_usp_pr_v1:07, jendela_tx_migration_pr_v1:06, zte_tx_mini_pr_v1:07
  hint: Use the unresolved review packet to compare the currently selected source against alternates.
...
- Batch priority `07` `CONFIRM_COMPETING_CANDIDATE` `subcontractor_ti`: Choose one exact four-layer source for `subcontractor_ti` from the competing shortlist candidates.
  profiles (3): celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: celcomdigi_usp_pr_v1:06, jendela_tx_migration_pr_v1:05, zte_tx_mini_pr_v1:06
  hint: Use the unresolved review packet to compare the currently selected source against alternates.
...
- Batch priority `09` `VERIFY_SINGLE_CANDIDATE` `du_key`: Verify the current single shortlist-aligned source for `du_key`.
  ...
  priority ids: cd_consolidation_2023_decom_pr_v1:07, cd_consolidation_2023_rollout_pr_v1:06, celcomdigi_bau_2023_pr_v1:07, celcomdigi_bau_2024_pr_v1:04, celcomdigi_usp_pr_v1:10, jendela_tx_migration_pr_v1:09, mw_eos_swap_pr_v1:05, tx_rollout_2023_pr_v1:02, zte_tx_mini_pr_v1:10
...
- Batch priority `10` `VERIFY_SINGLE_CANDIDATE` `antenna_size_fe`: Verify the current single shortlist-aligned source for `antenna_size_fe`.
  ...
  priority ids: celcomdigi_bau_2023_pr_v1:05, celcomdigi_bau_2024_pr_v1:02, celcomdigi_usp_pr_v1:08, jendela_tx_migration_pr_v1:07, mw_eos_swap_pr_v1:03, zte_tx_mini_pr_v1:08
  hint: Confirm the four-layer fingerprint and business meaning before changing mapping_status.
- Batch priority `11` `VERIFY_SINGLE_CANDIDATE` `antenna_size_ne`: Verify the current single shortlist-aligned source for `antenna_size_ne`.
  profiles (6): celcomdigi_bau_2023_pr_v1, celcomdigi_bau_2024_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, mw_eos_swap_pr_v1, zte_tx_mini_pr_v1
  priority ids: celcomdigi_bau_2023_pr_v1:06, celcomdigi_bau_2024_pr_v1:03, celcomdigi_usp_pr_v1:09, jendela_tx_migration_pr_v1:08, mw_eos_swap_pr_v1:04, zte_tx_mini_pr_v1:09
  hint: Confirm the four-layer fingerprint and business meaning before changing mapping_status.
- Batch priority `12` `VERIFY_SINGLE_CANDIDATE` `region`: Verify the current single shortlist-aligned source for `region`.
  profiles (4): celcomdigi_bau_2023_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: celcomdigi_bau_2023_pr_v1:08, celcomdigi_usp_pr_v1:11, jendela_tx_migration_pr_v1:10, zte_tx_mini_pr_v1:11
  hint: Confirm the four-layer fingerprint and business meaning before changing mapping_status.
- Batch priority `13` `VERIFY_SINGLE_CANDIDATE` `site_name`: Verify the current single shortlist-aligned source for `site_name`.
  ...
  hint: Confirm the four-layer fingerprint and business meaning before changing mapping_status.
- Batch priority `14` `VERIFY_SINGLE_CANDIDATE` `subcontractor_ti`: Verify the current single shortlist-aligned source for `subcontractor_ti`.
...
- Batch priority `15` `VERIFY_SINGLE_CANDIDATE` `site_code`: Verify the current single shortlist-aligned source for `site_code`.
  profiles (2): celcomdigi_bau_2023_pr_v1, jendela_tx_migration_pr_v1
  priority ids: celcomdigi_bau_2023_pr_v1:09, jendela_tx_migration_pr_v1:11
  hint: Confirm the four-layer fingerprint and business meaning before changing mapping_status.
- Batch priority `16` `APPROVE_HEADER_HASH`: Approve at least one header hash for this profile version after the field review is complete.
  profiles (6): cd_consolidation_2023_decom_pr_v1, cd_consolidation_2023_rollout_pr_v1, celcomdigi_bau_2023_pr_v1, celcomdigi_usp_pr_v1, jendela_tx_migration_pr_v1, zte_tx_mini_pr_v1
  priority ids: cd_consolidation_2023_decom_pr_v1:09, cd_consolidation_2023_rollout_pr_v1:09, celcomdigi_bau_2023_pr_v1:12, celcomdigi_usp_pr_v1:12, jendela_tx_migration_pr_v1:12, zte_tx_mini_pr_v1:12
...
- Batch priority `17` `HOLD_LIFECYCLE_PROMOTION`: Keep the profile blocked from lifecycle promotion until mapping review, header-hash approval, regression, and UAT evidence exist.
  ...
  priority ids: cd_consolidation_2023_decom_pr_v1:10, cd_consolidation_2023_rollout_pr_v1:10, celcomdigi_bau_2023_pr_v1:13, celcomdigi_bau_2024_pr_v1:06, celcomdigi_usp_pr_v1:13, jendela_tx_migration_pr_v1:13, mw_eos_swap_pr_v1:06, tx_mini_pr_v1:01, tx_rollout_2023_pr_v1:04, zte_tx_mini_pr_v1:13
